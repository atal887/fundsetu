...
export default function CivilScore() {
  ...
  const fixedScore = 739; // 🔹 Constant score for demo
      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        {step === 1 && user && (
          <>
            ...
            <p className="mb-4 text-gray-700">Please confirm your GST number to proceed.</p>
        ...
        {step === 3 && (
          <>
            ...
            <p className={`text-4xl font-bold mb-3 ${getScoreColor(fixedScore)}`}>
              {fixedScore}
            </p>
